...
def test_paligemma():
    ...
    model = PaliGemmaForConditionalGeneration.from_pretrained('/data2/user/qianlong_dataset/models/paligemma', torch_dtype=torch.bfloat16
                                                              ).eval().to('cuda:3')
    processor = PaliGemmaProcessor.from_pretrained('/data2/user/qianlong_dataset/models/paligemma')
