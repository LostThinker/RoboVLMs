...
class CotTag(enum.Enum):
    ...
    ACTION = "ACTION:"
    NEXT_GRIPPER_POSITION = "NEXT GRIPPER POSITION:"
    KEYFRAME = "KEYFRAME:"
...
def get_cot_tags_list():
    return [
        ...
        CotTag.NEXT_GRIPPER_POSITION.value,
        CotTag.KEYFRAME.value,
        CotTag.ACTION.value,
    ]
...
def get_cot_database_keys():
    return {
        ...
        CotTag.NEXT_GRIPPER_POSITION.value: "next_gripper",
        CotTag.KEYFRAME.value: "keyframe",
